...
func (h *VHostHandler) UpdateVHost(c *gin.Context) {
	...
	hJSON, bJSON, _ := h.marshalVHostInputs(input)
	query := `UPDATE vhosts SET name = $1, type = $2, domain = $3, backend_url = $4, backends = $5, load_balance_method = $6, custom_config = $7, ssl_enabled = $8, ssl_certificate_id = $9, ssl_cert_path = $10, ssl_key_path = $11, enabled = $12, websocket_enabled = $13, http_version = $14, tls_version = $15, max_upload_size = $16, proxy_read_timeout = $17, proxy_connect_timeout = $18, bot_detection_enabled = $19, bot_detection_type = $20, recaptcha_version = $21, rate_limit_enabled = $22, rate_limit_requests = $23, rate_limit_window = $24, region_whitelist = $25, region_blacklist = $26, region_filtering_enabled = $27, defense_mode = $28, custom_headers = $29, cache_enabled = $30, cache_ttl = $31, cache_methods = $32, cache_ignore_headers = $33, hsts_enabled = $34, hsts_max_age = $35, hsts_include_subdomains = $36, hsts_preload = $37, brotli_enabled = $38, http3_enabled = $39, hide_server_tokens = $40, security_headers_enabled = $41, updated_at = $42 WHERE id = $43`
