...
func getBotChallengeHTML(domain, challengeType, recaptchaVersion string) string {
	...
	case "turnstile":
		...
		challengeContent = getTurnstileHTML(domain)
...
func getTurnstileHTML(domain string) string {
...
func getRecaptchaV3HTML(domain string) string {
...
func getRecaptchaV2HTML(domain string) string {
...
func getSlidePuzzleHTML(domain string) string {
	return `
